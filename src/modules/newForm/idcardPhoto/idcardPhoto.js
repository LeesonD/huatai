    ...
    render() {
        return (
            <Container>
                ...
                <Content >
                    <div className="card"  >
                        <img className="card-img-top" src={require("../../images/idcardf.png")} alt="身份证人面照" />
                        <button className="btn btn-primary" onClick={()=>this.viewModel.takePhoto()}>拍摄身份证人面照</button>
                    </div>
                    <p/>
                    <div className="card" >
                        <img className="card-img-top" src={require("../../images/idcardb.png")} alt="身份国徽照"/>
                        <button className="btn btn-primary" onClick={()=>this.viewModel.takePhoto()}>拍摄身份证国徽照</button>
                    </div>
